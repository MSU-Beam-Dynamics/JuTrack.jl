...
function BendSymplecticPassRad_SC!(r::Vector{DTPSAD{N, T}}, le::DTPSAD{N, T}, beti::Float64, irho::DTPSAD{N, T}, A::Vector{DTPSAD{N, T}}, B::Vector{DTPSAD{N, T}}, 
    ...
    R1::Matrix{DTPSAD{N, T}}, R2::Matrix{DTPSAD{N, T}}, RApertures::Array{Float64,1}, EApertures::Array{Float64,1},
    KickAngle::Vector{DTPSAD{N, T}}, E0::DTPSAD{N, T}, num_particles::Int, lost_flags::Array{Int64,1},
    a::DTPSAD{N, T}, b::DTPSAD{N, T}, Nl::Int, Nm::Int, K::DTPSAD{N, T}, Nsteps::Int) where {N, T}
    # Ref[Terebilo, Andrei. "Accelerator modeling with MATLAB accelerator toolbox." PACS2001 (2001)].
    # and [Qiang, Ji. "Differentiable self-consistent space-charge simulation for accelerator design." Physical Review Accelerators and Beams 26.2 (2023): 024601.]
