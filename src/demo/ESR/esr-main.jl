...
HQF_1 = KQUAD(name="HQF_1", len=LQ50/2.0, k1=KF_1)
HQD_1 = KQUAD(name="HQD_1", len=LQ50/2.0, k1=KD_1)

HQF_3 = KQUAD(name="HQF_3", len=LQ50/2.0, k1=KF_3)
HQD_3 = KQUAD(name="HQD_3", len=LQ50/2.0, k1=KD_3)

HQF_5 = KQUAD(name="HQF_5", len=LQ50/2.0, k1=KF_5)
HQD_5 = KQUAD(name="HQD_5", len=LQ50/2.0, k1=KD_5)
HQF_5a = KQUAD(name="HQF_5a", len=LQ50/2.0, k1=KF_5a)
HQD_5a = KQUAD(name="HQD_5a", len=LQ50/2.0, k1=KD_5a)
HQF_5b = KQUAD(name="HQF_5b", len=LQ50/2.0, k1=KF_5b)
HQD_5b = KQUAD(name="HQD_5b", len=LQ50/2.0, k1=KD_5b)
HQF_5c = KQUAD(name="HQF_5c", len=LQ50/2.0, k1=KF_5c)
HQD_5c = KQUAD(name="HQD_5c", len=LQ50/2.0, k1=KD_5c)

HQF_6a = KQUAD(name="HQF_6a", len=LQ50/2.0, k1=KF_6a)
HQD_6a = KQUAD(name="HQD_6a", len=LQ50/2.0, k1=KD_6a)
HQF_6b = KQUAD(name="HQF_6b", len=LQ50/2.0, k1=KF_6b)
HQD_6b = KQUAD(name="HQD_6b", len=LQ50/2.0, k1=KD_6b)
HQF_6c = KQUAD(name="HQF_6c", len=LQ50/2.0, k1=KF_6c)
HQD_6c = KQUAD(name="HQD_6c", len=LQ50/2.0, k1=KD_6c)

HQF_7 = KQUAD(name="HQF_7", len=LQ50/2.0, k1=KF_7)
HQD_7 = KQUAD(name="HQD_7", len=LQ50/2.0, k1=KD_7)
HQF_7a = KQUAD(name="HQF_7a", len=LQ50/2.0, k1=KF_7a)
HQD_7a = KQUAD(name="HQD_7a", len=LQ50/2.0, k1=KD_7a)
HQF_7b = KQUAD(name="HQF_7b", len=LQ50/2.0, k1=KF_7b)
HQD_7b = KQUAD(name="HQD_7b", len=LQ50/2.0, k1=KD_7b)
HQF_7c = KQUAD(name="HQF_7c", len=LQ50/2.0, k1=KF_7c)
HQD_7c = KQUAD(name="HQD_7c", len=LQ50/2.0, k1=KD_7c)

HQF_8a = KQUAD(name="HQF_8a", len=LQ50/2.0, k1=KF_8a)
HQD_8a = KQUAD(name="HQD_8a", len=LQ50/2.0, k1=KD_8a)
HQF_8b = KQUAD(name="HQF_8b", len=LQ50/2.0, k1=KF_8b)
HQD_8b = KQUAD(name="HQD_8b", len=LQ50/2.0, k1=KD_8b)
HQF_8c = KQUAD(name="HQF_8c", len=LQ50/2.0, k1=KF_8c)
HQD_8c = KQUAD(name="HQD_8c", len=LQ50/2.0, k1=KD_8c)

HQF_9 = KQUAD(name="HQF_9", len=LQ50/2.0, k1=KF_9)
HQD_9 = KQUAD(name="HQD_9", len=LQ50/2.0, k1=KD_9)
...
HQF_11 = KQUAD(name="HQF_11", len=LQ50/2.0, k1=KF_11)
HQD_11 = KQUAD(name="HQD_11", len=LQ50/2.0, k1=KD_11)
#
# IR quads.
...
QFF1_5 = KQUAD(name="QFF1_5", len=LQ50, k1=KFF1_5)
QFF2_5 = KQUAD(name="QFF2_5", len=LQ50, k1=KFF2_5)
QFF3_5 = KQUAD(name="QFF3_5", len=LQ50, k1=KFF3_5)
QFF4_5 = KQUAD(name="QFF4_5", len=LQ50, k1=KFF4_5)
QFF5_5 = KQUAD(name="QFF5_5", len=LQ50, k1=KFF5_5)
QFF6_5 = KQUAD(name="QFF6_5", len=LQ50, k1=KFF6_5)
QFF1_6 = KQUAD(name="QFF1_6", len=LQ50, k1=KFF1_6)
QFF2_6 = KQUAD(name="QFF2_6", len=LQ50, k1=KFF2_6)
QFF3_6 = KQUAD(name="QFF3_6", len=LQ50, k1=KFF3_6)
QFF4_6 = KQUAD(name="QFF4_6", len=LQ50, k1=KFF4_6)
QFF5_6 = KQUAD(name="QFF5_6", len=LQ50, k1=KFF5_6)
QFF6_6 = KQUAD(name="QFF6_6", len=LQ50, k1=KFF6_6)
Q0EF_6 = KQUAD(name="Q0EF_6", len=lq0ef_6, k1=K0EF_6)
Q1EF_6 = KQUAD(name="Q1EF_6", len=lq1ef_6, k1=K1EF_6)
...
q1er_6 = KQUAD(name="q1er_6", len=lq1er_6, k1=K1ER_6)
q2er_6 = KQUAD(name="q2er_6", len=lq2er_6, k1=K2ER_6)
...
sq = KQUAD(name="sq", len=0.25)
sq2ef_6 = KQUAD(name="sq2ef_6", len=0.25)
sq3ef_6 = KQUAD(name="sq3ef_6", len=0.25)
sq4ef_6 = KQUAD(name="sq4ef_6", len=0.25)
sq5ef_6 = KQUAD(name="sq5ef_6", len=0.25)
sq6ef_6 = KQUAD(name="sq6ef_6", len=0.25)
sq7ef_6 = KQUAD(name="sq7ef_6", len=0.25)
sq8ef_6 = KQUAD(name="sq8ef_6", len=0.25)
sq9ef_6 = KQUAD(name="sq9ef_6", len=0.25)
sq10ef_6 = KQUAD(name="sq10ef_6", len=0.25)
sq11ef_6 = KQUAD(name="sq11ef_6", len=0.25)
sq12ef_6 = KQUAD(name="sq12ef_6", len=0.25)
sq13ef_6 = KQUAD(name="sq13ef_6", len=0.25)
sq14ef_6 = KQUAD(name="sq14ef_6", len=0.25)
sq3er_6 = KQUAD(name="sq3er_6", len=0.25)
sq4er_6 = KQUAD(name="sq4er_6", len=0.25)
sq5er_6 = KQUAD(name="sq5er_6", len=0.25)
sq6er_6 = KQUAD(name="sq6er_6", len=0.25)
sq7er_6 = KQUAD(name="sq7er_6", len=0.25)
sq8er_6 = KQUAD(name="sq8er_6", len=0.25)
sq9er_6 = KQUAD(name="sq9er_6", len=0.25)
sq10er_6 = KQUAD(name="sq10er_6", len=0.25)
#
# IP8 quadrupoles.
HQSS1_7 = KQUAD(name="HQSS1_7", len=LQSS1/2.0, k1=KQSS1_7)
HQSS2_7 = KQUAD(name="HQSS2_7", len=LQSS2/2.0, k1=KQSS2_7)
HQSS3_7 = KQUAD(name="HQSS3_7", len=LQSS3/2.0, k1=KQSS3_7)
HQSS4_7 = KQUAD(name="HQSS4_7", len=LQSS4/2.0, k1=KQSS4_7)
HQSS5_7 = KQUAD(name="HQSS5_7", len=LQSS5/2.0, k1=KQSS5_7)
HQSS1_8 = KQUAD(name="HQSS1_8", len=LQSS1/2.0, k1=KQSS1_8)
HQSS2_8 = KQUAD(name="HQSS2_8", len=LQSS2/2.0, k1=KQSS2_8)
HQSS3_8 = KQUAD(name="HQSS3_8", len=LQSS3/2.0, k1=KQSS3_8)
HQSS4_8 = KQUAD(name="HQSS4_8", len=LQSS4/2.0, k1=KQSS4_8)
HQSS5_8 = KQUAD(name="HQSS5_8", len=LQSS5/2.0, k1=KQSS5_8)
HQLS1_7 = KQUAD(name="HQLS1_7", len=LQLS1/2.0, k1=KQLS1_7)
HQLS2_7 = KQUAD(name="HQLS2_7", len=LQLS2/2.0, k1=KQLS2_7)
HQLS3_7 = KQUAD(name="HQLS3_7", len=LQLS3/2.0, k1=KQLS3_7)
HQLS4_7 = KQUAD(name="HQLS4_7", len=LQLS4/2.0, k1=KQLS4_7)
HQLS5_7 = KQUAD(name="HQLS5_7", len=LQLS3/2.0, k1=KQLS5_7)
HQLS6_7 = KQUAD(name="HQLS6_7", len=LQLS2/2.0, k1=KQLS6_7)
HQLS7_7 = KQUAD(name="HQLS7_7", len=LQLS1/2.0, k1=KQLS7_7)
HQLS1_8 = KQUAD(name="HQLS1_8", len=LQLS1/2.0, k1=KQLS1_8)
HQLS2_8 = KQUAD(name="HQLS2_8", len=LQLS2/2.0, k1=KQLS2_8)
HQLS3_8 = KQUAD(name="HQLS3_8", len=LQLS3/2.0, k1=KQLS3_8)
HQLS4_8 = KQUAD(name="HQLS4_8", len=LQLS4/2.0, k1=KQLS4_8)
HQLS5_8 = KQUAD(name="HQLS5_8", len=LQLS3/2.0, k1=KQLS5_8)
HQLS6_8 = KQUAD(name="HQLS6_8", len=LQLS2/2.0, k1=KQLS6_8)
HQLS7_8 = KQUAD(name="HQLS7_8", len=LQLS1/2.0, k1=KQLS7_8)
QFF1_7 = KQUAD(name="QFF1_7", len=LQ50, k1=KFF1_7)
QFF2_7 = KQUAD(name="QFF2_7", len=LQ50, k1=KFF2_7)
QFF3_7 = KQUAD(name="QFF3_7", len=LQ50, k1=KFF3_7)
QFF4_7 = KQUAD(name="QFF4_7", len=LQ50, k1=KFF4_7)
QFF5_7 = KQUAD(name="QFF5_7", len=LQ50, k1=KFF5_7)
QFF6_7 = KQUAD(name="QFF6_7", len=LQ50, k1=KFF6_7)
QFF1_8 = KQUAD(name="QFF1_8", len=LQ50, k1=KFF1_8)
QFF2_8 = KQUAD(name="QFF2_8", len=LQ50, k1=KFF2_8)
QFF3_8 = KQUAD(name="QFF3_8", len=LQ50, k1=KFF3_8)
QFF4_8 = KQUAD(name="QFF4_8", len=LQ50, k1=KFF4_8)
QFF5_8 = KQUAD(name="QFF5_8", len=LQ50, k1=KFF5_8)
QFF6_8 = KQUAD(name="QFF6_8", len=LQ50, k1=KFF6_8)
q0ef_8 = KQUAD(name="q0ef_8", len=lq0ef_6, k1=K0EF_8)
q1ef_8 = KQUAD(name="q1ef_8", len=lq1ef_6, k1=K1EF_8)
...
q1er_8 = KQUAD(name="q1er_8", len=lq1er_6, k1=K1ER_8)
q2er_8 = KQUAD(name="q2er_8", len=lq2er_6, k1=K2ER_8)
...
#
# IP10 quadrupoles.
HQM22_9 = KQUAD(name="HQM22_9", len=LQ80/2.0, k1=KM22_9)
HQM21_9 = KQUAD(name="HQM21_9", len=LQ80/2.0, k1=KM21_9)
HQM20_9 = KQUAD(name="HQM20_9", len=LQ80/2.0, k1=KM20_9)
HQM19_9 = KQUAD(name="HQM19_9", len=LQ80/2.0, k1=KM19_9)
HQM18_9 = KQUAD(name="HQM18_9", len=LQ80/2.0, k1=KM18_9)
HQM17_9 = KQUAD(name="HQM17_9", len=LQ80/2.0, k1=KM17_9)
HQM16_9 = KQUAD(name="HQM16_9", len=LQ80/2.0, k1=KM16_9)
HQM15_9 = KQUAD(name="HQM15_9", len=LQ80/2.0, k1=KM15_9)
HQM14_9 = KQUAD(name="HQM14_9", len=LQ80/2.0, k1=KM14_9)
HQM13_9 = KQUAD(name="HQM13_9", len=LQ80/2.0, k1=KM13_9)
HQM12_9 = KQUAD(name="HQM12_9", len=LQ80/2.0, k1=KM12_9)
HQDSS_10 = KQUAD(name="HQDSS_10", len=LQ80/2.0, k1=KDSS_10)
HQFSS_10 = KQUAD(name="HQFSS_10", len=LQ80/2.0, k1=KFSS_10)
HQDLSS_10 = KQUAD(name="HQDLSS_10", len=LQ60, k1=KDSSL_10)
HQFLSS_10 = KQUAD(name="HQFLSS_10", len=LQ60, k1=KFSSL_10)
HQM22_10 = KQUAD(name="HQM22_10", len=LQ80/2.0, k1=KM22_10)
HQM21_10 = KQUAD(name="HQM21_10", len=LQ80/2.0, k1=KM21_10)
HQM20_10 = KQUAD(name="HQM20_10", len=LQ80/2.0, k1=KM20_10)
HQM19_10 = KQUAD(name="HQM19_10", len=LQ80/2.0, k1=KM19_10)
HQM18_10 = KQUAD(name="HQM18_10", len=LQ80/2.0, k1=KM18_10)
HQM17_10 = KQUAD(name="HQM17_10", len=LQ80/2.0, k1=KM17_10)
HQM16_10 = KQUAD(name="HQM16_10", len=LQ80/2.0, k1=KM16_10)
HQM15_10 = KQUAD(name="HQM15_10", len=LQ80/2.0, k1=KM15_10)
HQM14_10 = KQUAD(name="HQM14_10", len=LQ80/2.0, k1=KM14_10)
HQM13_10 = KQUAD(name="HQM13_10", len=LQ80/2.0, k1=KM13_10)
HQM12_10 = KQUAD(name="HQM12_10", len=LQ80/2.0, k1=KM12_10)
#
# IP12 quadrupoles.
HQM22_11 = KQUAD(name="HQM22_11", len=LQ80/2.0, k1=KM22_11)
HQM21_11 = KQUAD(name="HQM21_11", len=LQ80/2.0, k1=KM21_11)
HQM20_11 = KQUAD(name="HQM20_11", len=LQ80/2.0, k1=KM20_11)
HQM19_11 = KQUAD(name="HQM19_11", len=LQ80/2.0, k1=KM19_11)
HQM18_11 = KQUAD(name="HQM18_11", len=LQ80/2.0, k1=KM18_11)
HQM17_11 = KQUAD(name="HQM17_11", len=LQ80/2.0, k1=KM17_11)
HQM16_11 = KQUAD(name="HQM16_11", len=LQ80/2.0, k1=KM16_11)
HQM15_11 = KQUAD(name="HQM15_11", len=LQ80/2.0, k1=KM15_11)
HQM14_11 = KQUAD(name="HQM14_11", len=LQ80/2.0, k1=KM14_11)
HQM13_11 = KQUAD(name="HQM13_11", len=LQ80/2.0, k1=KM13_11)
HQM12_11 = KQUAD(name="HQM12_11", len=LQ80/2.0, k1=KM12_11)
HQDSS_12 = KQUAD(name="HQDSS_12", len=LQ80/2.0, k1=KDSS_12)
HQFSS_12 = KQUAD(name="HQFSS_12", len=LQ80/2.0, k1=KFSS_12)
HQM22_12 = KQUAD(name="HQM22_12", len=LQ80/2.0, k1=KM22_12)
HQM21_12 = KQUAD(name="HQM21_12", len=LQ80/2.0, k1=KM21_12)
HQM20_12 = KQUAD(name="HQM20_12", len=LQ80/2.0, k1=KM20_12)
HQM19_12 = KQUAD(name="HQM19_12", len=LQ80/2.0, k1=KM19_12)
HQM18_12 = KQUAD(name="HQM18_12", len=LQ80/2.0, k1=KM18_12)
HQM17_12 = KQUAD(name="HQM17_12", len=LQ80/2.0, k1=KM17_12)
HQM16_12 = KQUAD(name="HQM16_12", len=LQ80/2.0, k1=KM16_12)
HQM15_12 = KQUAD(name="HQM15_12", len=LQ80/2.0, k1=KM15_12)
HQM14_12 = KQUAD(name="HQM14_12", len=LQ80/2.0, k1=KM14_12)
#
# IP2 quadrupoles.
...
#
# IP4 quadrupoles.
HQD17_3 = KQUAD(name="HQD17_3", len=LQ80/2.0, k1=KD17_3)
HQF16_3 = KQUAD(name="HQF16_3", len=LQ80/2.0, k1=KF16_3)
HQD15_3 = KQUAD(name="HQD15_3", len=LQ80/2.0, k1=KD15_3)
HQF14_3 = KQUAD(name="HQF14_3", len=LQ80/2.0, k1=KF14_3)
HQD13_3 = KQUAD(name="HQD13_3", len=LQ80/2.0, k1=KD13_3)
HQF12_3 = KQUAD(name="HQF12_3", len=LQ80/2.0, k1=KF12_3)
HQD11_3 = KQUAD(name="HQD11_3", len=LQ80/2.0, k1=KD11_3)
HQF10_3 = KQUAD(name="HQF10_3", len=LQ80/2.0, k1=KF10_3)
HQD9_3 = KQUAD(name="HQD9_3", len=LQ80/2.0, k1=KD9_3)
HQF8_3 = KQUAD(name="HQF8_3", len=LQ80/2.0, k1=KF8_3)
HQD7_3 = KQUAD(name="HQD7_3", len=LQ80/2.0, k1=KD7_3)
HQF6_3 = KQUAD(name="HQF6_3", len=LQ80/2.0, k1=KF6_3)
HQD5_3 = KQUAD(name="HQD5_3", len=LQ80/2.0, k1=KD5_3)
HQF4_3 = KQUAD(name="HQF4_3", len=LQ80/2.0, k1=KF4_3)
HQD3_3 = KQUAD(name="HQD3_3", len=LQ80/2.0, k1=KD3_3)
HQF2_3 = KQUAD(name="HQF2_3", len=LQ80/2.0, k1=KF2_3)
HQD1_3 = KQUAD(name="HQD1_3", len=LQ80/2.0, k1=KD1_3)
HQF18_4 = KQUAD(name="HQF18_4", len=LQ80/2.0, k1=KF18_4)
HQD17_4 = KQUAD(name="HQD17_4", len=LQ80/2.0, k1=KD17_4)
HQF16_4 = KQUAD(name="HQF16_4", len=LQ80/2.0, k1=KF16_4)
HQD15_4 = KQUAD(name="HQD15_4", len=LQ80/2.0, k1=KD15_4)
HQF14_4 = KQUAD(name="HQF14_4", len=LQ80/2.0, k1=KF14_4)
HQD13_4 = KQUAD(name="HQD13_4", len=LQ80/2.0, k1=KD13_4)
HQF12_4 = KQUAD(name="HQF12_4", len=LQ80/2.0, k1=KF12_4)
HQD11_4 = KQUAD(name="HQD11_4", len=LQ80/2.0, k1=KD11_4)
HQF10_4 = KQUAD(name="HQF10_4", len=LQ80/2.0, k1=KF10_4)
HQD9_4 = KQUAD(name="HQD9_4", len=LQ80/2.0, k1=KD9_4)
HQF8_4 = KQUAD(name="HQF8_4", len=LQ80/2.0, k1=KF8_4)
HQD7_4 = KQUAD(name="HQD7_4", len=LQ80/2.0, k1=KD7_4)
HQF6_4 = KQUAD(name="HQF6_4", len=LQ80/2.0, k1=KF6_4)
HQD5_4 = KQUAD(name="HQD5_4", len=LQ80/2.0, k1=KD5_4)
HQF4_4 = KQUAD(name="HQF4_4", len=LQ80/2.0, k1=KF4_4)
HQD3_4 = KQUAD(name="HQD3_4", len=LQ80/2.0, k1=KD3_4)
HQF2_4 = KQUAD(name="HQF2_4", len=LQ80/2.0, k1=KF2_4)
HQD1_4 = KQUAD(name="HQD1_4", len=LQ80/2.0, k1=KD1_4)
#
# ======= The sextupoles ==================================
# ARC 1 sextupoles.
