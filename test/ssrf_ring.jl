...
function ssrf(K1)
    ...
    QL1 = KQUAD(name="QL1", len=0.32, k1=K1 )
    ...
    CAV = RFCA(name="CAV1", len=0.1, volt=4.0e6, freq=HarmNumber*C0/L0)
    
       # M1 = [DL,  QL1, D1,  S1,   D2,   QL2H, QL2H,  D33]
       # push!(M1, QL3,  D51,  S2,  D52,  BD1, BD2,  D6,   QL4)
       # push!(M1, D7,   SD,   D8, QL5,  D9,  SF)
       # push!(M1, D9,   QM5,  D8,  SD,   D7,  QM4,  D6,  BD1, BD2)
       # push!(M1, D5,   QM3,  D4,  S4,   D3,  Q2H, Q2H,  D2,  S3,  D1, QM1, DM)

       # M2 = [DM,   QM1, D1,   S3,  D2,   Q2H, Q2H, D3]
       # push!(M2, S4,   D4 ,  QM3, D5,  BD1, BD2,  D6,   QM4)
       # push!(M2, D7,   SD ,  D8,   QM5, D9,  SF)
       # push!(M2, D9,   QM5,  D8,   SD,  D7,  QM4,  D6,  BD1, BD2)
       # push!(M2, D5,   QM3,  D4,   S6,  D3,  Q2H, Q2H,  D2,  S5,  D1, QM1, DM)

       # M3 = [DM,   QM1,  D1,   S5,  D2,   Q2H, Q2H, D3]
       # push!(M3, S6,   D4,   QM3,  D5,  BD1, BD2,  D6,   QM4)
       # push!(M3, D7,   SD,   D8,    QM5, D9,  SF)
       # push!(M3, D9,   QM5,  D8,   SD,  D7,  QM4,  D6,  BD1, BD2)
       # push!(M3, D5,   QM3,  D4,   S6,  D3,  Q2H, Q2H,  D2,  S5,  D1,  QM1, DM)

       # M4 = [DM,   QM1,   D1,   S5,  D2,  Q2H, Q2H,  D3]
       # push!(M4, S6,   D4 ,  QM3,  D5,  BD1, BD2,  D6,   QM4)
       # push!(M4, D7,   SD ,  D8,   QM5, D9,  SF)
       # push!(M4, D9,   QM5,  D8,   SD,   D7,  QM4,  D6,  BD1, BD2)
       # push!(M4, D5,   QM3,  D4,   S4,  D3,  Q2H, Q2H,  D2,  S3,  D1,  QM1, DM)

       # M5 = [DM,   QM1,  D1,  S3,  D2,  Q2H, Q2H,  D3]
       # push!(M5, S4,   D4,   QM3,  D5,  BD1, BD2,  D6,   QM4)
       # push!(M5, D7,   SD,   D8,   QM5, D9,  SF)
       # push!(M5, D9,   QL5,  D8,   SD,  D7, QL4,  D6,  BD1, BD2)
       # push!(M5, D52,  S2,   D51,  QL3,  D33,  QL2H, QL2H,  D2, S1,  D1,  QL1,  DL)
