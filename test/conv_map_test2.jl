...
function CHICANE(ANGLE_ARC, TH2XX, ID) 
   ...
   D01A_ID = SBEND(name="D01A_"*ID, len=L01_ID, angle=0.5*(ANGLE_ARC)-(TH2_ID))
   D23_ID = SBEND(name="D23_"*ID, len=L23_ID, angle=2*(TH2_ID))
   D01B_ID = SBEND(name="D01B_"*ID, len=L01_ID, angle=0.5*(ANGLE_ARC)-(TH2_ID))
...
# DB23_3 = RBEND(name="DB23_3", len=L01_STR, angle=ROT_ANGLE)
# DB23_4 = RBEND(name="DB23_4", len=L01_STR, angle=ROT_ANGLE)
...
# DB23_9 = RBEND(name="DB23_9", len=L01_STR, angle=ROT_ANGLE)
# DB23_10 = RBEND(name="DB23_10", len=L01_STR, angle=ROT_ANGLE)
# DB23_11 = RBEND(name="DB23_11", len=L01_STR, angle=ROT_ANGLE)
# DB23_12 = RBEND(name="DB23_12", len=L01_STR, angle=ROT_ANGLE)
# DB12P = RBEND(name="DB12P", len=L01_STR, angle=ADB12_4)
# DB12M = RBEND(name="DB12M", len=L01_STR, angle=-ADB12_4)
# DB4P = RBEND(name="DB4P", len=L01_STR, angle=ADB12_4)
# DB4M = RBEND(name="DB4M", len=L01_STR, angle=-ADB12_4)
...
DB23_1 = RBEND(name="DB23_1", len=L01_STR*ROT_ANGLE/2/sin(ROT_ANGLE/2), angle=ROT_ANGLE, rad=0)
DB23_2 = RBEND(name="DB23_2", len=L01_STR*ROT_ANGLE/2/sin(ROT_ANGLE/2), angle=ROT_ANGLE, rad=0)
DB23_3 = RBEND(name="DB23_3", len=L01_STR*ROT_ANGLE/2/sin(ROT_ANGLE/2), angle=ROT_ANGLE, rad=0)
DB23_4 = RBEND(name="DB23_4", len=L01_STR*ROT_ANGLE/2/sin(ROT_ANGLE/2), angle=ROT_ANGLE, rad=0)
DB23_5 = RBEND(name="DB23_5", len=3.8*theta1/5/2/sin(theta1/5/2), angle=theta1/5, rad=0)
DB23_6 = RBEND(name="DB23_6", len=3.8*theta1/5/2/sin(theta1/5/2), angle=theta1/5, rad=0)
DB23_7 = RBEND(name="DB23_7", len=3.8*theta1/5/2/sin(theta1/5/2), angle=theta1/5, rad=0)
DB23_8 = RBEND(name="DB23_8", len=3.8*theta1/5/2/sin(theta1/5/2), angle=theta1/5, rad=0)
DB23_9 = RBEND(name="DB23_9", len=L01_STR*ROT_ANGLE/2/sin(ROT_ANGLE/2), angle=ROT_ANGLE, rad=0)
DB23_10 = RBEND(name="DB23_10", len=L01_STR*ROT_ANGLE/2/sin(ROT_ANGLE/2), angle=ROT_ANGLE, rad=0)
DB23_11 = RBEND(name="DB23_11", len=L01_STR*ROT_ANGLE/2/sin(ROT_ANGLE/2), angle=ROT_ANGLE, rad=0)
DB23_12 = RBEND(name="DB23_12", len=L01_STR*ROT_ANGLE/2/sin(ROT_ANGLE/2), angle=ROT_ANGLE, rad=0)
DB12P = RBEND(name="DB12P", len=L01_STR*ADB12_4/2/sin(ADB12_4/2), angle=ADB12_4, rad=0)
DB12M = RBEND(name="DB12M", len=L01_STR*ADB12_4/2/sin(ADB12_4/2), angle=-ADB12_4, rad=0)
DB4P = RBEND(name="DB4P", len=L01_STR*ADB12_4/2/sin(ADB12_4/2), angle=ADB12_4, rad=0)
DB4M = RBEND(name="DB4M", len=L01_STR*ADB12_4/2/sin(ADB12_4/2), angle=-ADB12_4, rad=0)
d1ef_6 = RBEND(name="d1ef_6", len=L23_STR*db1ef_ang_6/2/sin(db1ef_ang_6/2), angle=db1ef_ang_6, rad=0)
d2ef_6 = RBEND(name="d2ef_6", len=L01_STR*db2ef_ang_6/2/sin(db2ef_ang_6/2), angle=db2ef_ang_6, rad=0)
d3ef_6 = RBEND(name="d3ef_6", len=L01_STR*db3ef_ang_6/2/sin(db3ef_ang_6/2), angle=db3ef_ang_6, rad=0)
d4ef_6 = RBEND(name="d4ef_6", len=L01_STR*db4ef_ang_6/2/sin(db4ef_ang_6/2), angle=db4ef_ang_6, rad=0)
d5ef_6 = RBEND(name="d5ef_6", len=L01_STR*db5ef_ang_6/2/sin(db5ef_ang_6/2), angle=db5ef_ang_6, rad=0)
d2er_6 = RBEND(name="d2er_6", len=lrd2er*DB2ER_ANG_6/2/sin(DB2ER_ANG_6/2), angle=DB2ER_ANG_6, rad=0)
d3er_6 = RBEND(name="d3er_6", len=L01_STR*DB3ER_ANG_6/2/sin(DB3ER_ANG_6/2), angle=DB3ER_ANG_6, rad=0)
d4er_6 = RBEND(name="d4er_6", len=L01_STR*DB4ER_ANG_6/2/sin(DB4ER_ANG_6/2), angle=DB4ER_ANG_6, rad=0)
d1ef_8 = RBEND(name="d1ef_8", len=L23_STR*DB1EF_ANG_8/2/sin(DB1EF_ANG_8/2), angle=DB1EF_ANG_8, rad=0)
d2ef_8 = RBEND(name="d2ef_8", len=L01_STR*DB2EF_ANG_8/2/sin(DB2EF_ANG_8/2), angle=DB2EF_ANG_8, rad=0)
d3ef_8 = RBEND(name="d3ef_8", len=3.8*DB3EF_ANG_8/2/sin(DB3EF_ANG_8/2), angle=DB3EF_ANG_8, rad=0)
d2er_8 = RBEND(name="d2er_8", len=lrd2er*DB2ER_ANG_8/2/sin(DB2ER_ANG_8/2), angle=DB2ER_ANG_8, rad=0)
d3er_8 = RBEND(name="d3er_8", len=L01_STR*DB3ER_ANG_8/2/sin(DB3ER_ANG_8/2), angle=DB3ER_ANG_8, rad=0)
d4er_8 = RBEND(name="d4er_8", len=L01_STR*DB4ER_ANG_8/2/sin(DB4ER_ANG_8/2), angle=DB4ER_ANG_8, rad=0)
d5er_8 = RBEND(name="d5er_8", len=L01_STR*DB5ER_ANG_8/2/sin(DB5ER_ANG_8/2), angle=DB5ER_ANG_8, rad=0)
#
# ======= The quadrupoles =================================
#
# ------- The arc quadrupoles -----------------------------
# HQF_AVE = QUAD(name="HQF_AVE", len=LQ50/2.0, k1=KF_AVE)
# HQD_AVE = QUAD(name="HQD_AVE", len=LQ50/2.0, k1=KD_AVE)

HQF_1 = QUAD(name="HQF_1", len=LQ50/2.0, k1=KF_1)
HQD_1 = QUAD(name="HQD_1", len=LQ50/2.0, k1=KD_1)

HQF_3 = QUAD(name="HQF_3", len=LQ50/2.0, k1=KF_3)
HQD_3 = QUAD(name="HQD_3", len=LQ50/2.0, k1=KD_3)

HQF_5 = QUAD(name="HQF_5", len=LQ50/2.0, k1=KF_5)
HQD_5 = QUAD(name="HQD_5", len=LQ50/2.0, k1=KD_5)
HQF_5a = QUAD(name="HQF_5a", len=LQ50/2.0, k1=KF_5a)
HQD_5a = QUAD(name="HQD_5a", len=LQ50/2.0, k1=KD_5a)
HQF_5b = QUAD(name="HQF_5b", len=LQ50/2.0, k1=KF_5b)
HQD_5b = QUAD(name="HQD_5b", len=LQ50/2.0, k1=KD_5b)
HQF_5c = QUAD(name="HQF_5c", len=LQ50/2.0, k1=KF_5c)
HQD_5c = QUAD(name="HQD_5c", len=LQ50/2.0, k1=KD_5c)

HQF_6a = QUAD(name="HQF_6a", len=LQ50/2.0, k1=KF_6a)
HQD_6a = QUAD(name="HQD_6a", len=LQ50/2.0, k1=KD_6a)
HQF_6b = QUAD(name="HQF_6b", len=LQ50/2.0, k1=KF_6b)
HQD_6b = QUAD(name="HQD_6b", len=LQ50/2.0, k1=KD_6b)
HQF_6c = QUAD(name="HQF_6c", len=LQ50/2.0, k1=KF_6c)
HQD_6c = QUAD(name="HQD_6c", len=LQ50/2.0, k1=KD_6c)

HQF_7 = QUAD(name="HQF_7", len=LQ50/2.0, k1=KF_7)
HQD_7 = QUAD(name="HQD_7", len=LQ50/2.0, k1=KD_7)
HQF_7a = QUAD(name="HQF_7a", len=LQ50/2.0, k1=KF_7a)
HQD_7a = QUAD(name="HQD_7a", len=LQ50/2.0, k1=KD_7a)
HQF_7b = QUAD(name="HQF_7b", len=LQ50/2.0, k1=KF_7b)
HQD_7b = QUAD(name="HQD_7b", len=LQ50/2.0, k1=KD_7b)
HQF_7c = QUAD(name="HQF_7c", len=LQ50/2.0, k1=KF_7c)
HQD_7c = QUAD(name="HQD_7c", len=LQ50/2.0, k1=KD_7c)

HQF_8a = QUAD(name="HQF_8a", len=LQ50/2.0, k1=KF_8a)
HQD_8a = QUAD(name="HQD_8a", len=LQ50/2.0, k1=KD_8a)
HQF_8b = QUAD(name="HQF_8b", len=LQ50/2.0, k1=KF_8b)
HQD_8b = QUAD(name="HQD_8b", len=LQ50/2.0, k1=KD_8b)
HQF_8c = QUAD(name="HQF_8c", len=LQ50/2.0, k1=KF_8c)
HQD_8c = QUAD(name="HQD_8c", len=LQ50/2.0, k1=KD_8c)

HQF_9 = QUAD(name="HQF_9", len=LQ50/2.0, k1=KF_9)
HQD_9 = QUAD(name="HQD_9", len=LQ50/2.0, k1=KD_9)
# HQF_9a = QUAD(name="HQF_9a", len=LQ50/2.0, k1=KF_9a)
# HQD_9a = QUAD(name="HQD_9a", len=LQ50/2.0, k1=KD_9a)
# HQF_9b = QUAD(name="HQF_9b", len=LQ50/2.0, k1=KF_9b)
# HQD_9b = QUAD(name="HQD_9b", len=LQ50/2.0, k1=KD_9b)
# HQF_9c = QUAD(name="HQF_9c", len=LQ50/2.0, k1=KF_9c)
# HQD_9c = QUAD(name="HQD_9c", len=LQ50/2.0, k1=KD_9c)

HQF_11 = QUAD(name="HQF_11", len=LQ50/2.0, k1=KF_11)
HQD_11 = QUAD(name="HQD_11", len=LQ50/2.0, k1=KD_11)
#
# IR quads.
qir06 = QUAD(name="qir06", len=lqir06)
qir12 = QUAD(name="qir12", len=lqir12)
#
# IP6 quadrupoles.
HQSS1_5 = QUAD(name="HQSS1_5", len=LQSS1/2.0, k1=KQSS1_5)
HQSS2_5 = QUAD(name="HQSS2_5", len=LQSS2/2.0, k1=KQSS2_5)
HQSS3_5 = QUAD(name="HQSS3_5", len=LQSS3/2.0, k1=KQSS3_5)
HQSS4_5 = QUAD(name="HQSS4_5", len=LQSS4/2.0, k1=KQSS4_5)
HQSS5_5 = QUAD(name="HQSS5_5", len=LQSS5/2.0, k1=KQSS5_5)
HQSS1_6 = QUAD(name="HQSS1_6", len=LQSS1/2.0, k1=KQSS1_6)
HQSS2_6 = QUAD(name="HQSS2_6", len=LQSS2/2.0, k1=KQSS2_6)
HQSS3_6 = QUAD(name="HQSS3_6", len=LQSS3/2.0, k1=KQSS3_6)
HQSS4_6 = QUAD(name="HQSS4_6", len=LQSS4/2.0, k1=KQSS4_6)
HQSS5_6 = QUAD(name="HQSS5_6", len=LQSS5/2.0, k1=KQSS5_6)
HQLS1_5 = QUAD(name="HQLS1_5", len=LQLS1/2.0, k1=KQLS1_5)
HQLS2_5 = QUAD(name="HQLS2_5", len=LQLS2/2.0, k1=KQLS2_5)
HQLS3_5 = QUAD(name="HQLS3_5", len=LQLS3/2.0, k1=KQLS3_5)
HQLS4_5 = QUAD(name="HQLS4_5", len=LQLS4/2.0, k1=KQLS4_5)
HQLS5_5 = QUAD(name="HQLS5_5", len=LQLS3/2.0, k1=KQLS5_5)
HQLS6_5 = QUAD(name="HQLS6_5", len=LQLS2/2.0, k1=KQLS6_5)
HQLS7_5 = QUAD(name="HQLS7_5", len=LQLS1/2.0, k1=KQLS7_5)
HQLS1_6 = QUAD(name="HQLS1_6", len=LQLS1/2.0, k1=KQLS1_6)
HQLS2_6 = QUAD(name="HQLS2_6", len=LQLS2/2.0, k1=KQLS2_6)
HQLS3_6 = QUAD(name="HQLS3_6", len=LQLS3/2.0, k1=KQLS3_6)
HQLS4_6 = QUAD(name="HQLS4_6", len=LQLS4/2.0, k1=KQLS4_6)
HQLS5_6 = QUAD(name="HQLS5_6", len=LQLS3/2.0, k1=KQLS5_6)
HQLS6_6 = QUAD(name="HQLS6_6", len=LQLS2/2.0, k1=KQLS6_6)
HQLS7_6 = QUAD(name="HQLS7_6", len=LQLS1/2.0, k1=KQLS7_6)
QFF1_5 = QUAD(name="QFF1_5", len=LQ50, k1=KFF1_5)
QFF2_5 = QUAD(name="QFF2_5", len=LQ50, k1=KFF2_5)
QFF3_5 = QUAD(name="QFF3_5", len=LQ50, k1=KFF3_5)
QFF4_5 = QUAD(name="QFF4_5", len=LQ50, k1=KFF4_5)
QFF5_5 = QUAD(name="QFF5_5", len=LQ50, k1=KFF5_5)
QFF6_5 = QUAD(name="QFF6_5", len=LQ50, k1=KFF6_5)
QFF1_6 = QUAD(name="QFF1_6", len=LQ50, k1=KFF1_6)
QFF2_6 = QUAD(name="QFF2_6", len=LQ50, k1=KFF2_6)
QFF3_6 = QUAD(name="QFF3_6", len=LQ50, k1=KFF3_6)
QFF4_6 = QUAD(name="QFF4_6", len=LQ50, k1=KFF4_6)
QFF5_6 = QUAD(name="QFF5_6", len=LQ50, k1=KFF5_6)
QFF6_6 = QUAD(name="QFF6_6", len=LQ50, k1=KFF6_6)
Q0EF_6 = QUAD(name="Q0EF_6", len=lq0ef_6, k1=K0EF_6)
Q1EF_6 = QUAD(name="Q1EF_6", len=lq1ef_6, k1=K1EF_6)
q2ef_6 = QUAD(name="q2ef_6", len=0.6, k1=K2EF_6)
q3ef_6 = QUAD(name="q3ef_6", len=0.6, k1=K3EF_6)
q4ef_6 = QUAD(name="q4ef_6", len=1.2, k1=K4EF_6)
q5ef_6 = QUAD(name="q5ef_6", len=1.2, k1=K5EF_6)
q6ef_6 = QUAD(name="q6ef_6", len=1.2, k1=K6EF_6)
q7ef_6 = QUAD(name="q7ef_6", len=1.2, k1=K7EF_6)
q8ef_6 = QUAD(name="q8ef_6", len=1.2, k1=K8EF_6)
q9ef_6 = QUAD(name="q9ef_6", len=1.2, k1=K9EF_6)
q10ef_6 = QUAD(name="q10ef_6", len=1.2, k1=K10EF_6)
q11ef_6 = QUAD(name="q11ef_6", len=1.2, k1=K11EF_6)
q12ef_6 = QUAD(name="q12ef_6", len=1.2, k1=K12EF_6)
q13ef_6 = QUAD(name="q13ef_6", len=1.2, k1=K13EF_6)
q14ef_6 = QUAD(name="q14ef_6", len=1.2, k1=K14EF_6)
q1er_6 = QUAD(name="q1er_6", len=lq1er_6, k1=K1ER_6)
q2er_6 = QUAD(name="q2er_6", len=lq2er_6, k1=K2ER_6)
q3er_6 = QUAD(name="q3er_6", len=0.6, k1=K3ER_6)
q4er_6 = QUAD(name="q4er_6", len=0.6, k1=K4ER_6)
q5er_6 = QUAD(name="q5er_6", len=0.6, k1=K5ER_6)
q6er_6 = QUAD(name="q6er_6", len=1.2, k1=K6ER_6)
q7er_6 = QUAD(name="q7er_6", len=1.2, k1=K7ER_6)
q8er_6 = QUAD(name="q8er_6", len=1.2, k1=K8ER_6)
q9er_6 = QUAD(name="q9er_6", len=1.2, k1=K9ER_6)
q10er_6 = QUAD(name="q10er_6", len=1.2, k1=K10ER_6)
q11er_6 = QUAD(name="q11er_6", len=1.2, k1=K11ER_6)
q12er_6 = QUAD(name="q12er_6", len=1.2, k1=K12ER_6)
q13er_6 = QUAD(name="q13er_6", len=1.2, k1=K13ER_6)
q14er_6 = QUAD(name="q14er_6", len=1.2, k1=K14ER_6)
q15er_6 = QUAD(name="q15er_6", len=1.2, k1=K15ER_6)
sq = QUAD(name="sq", len=0.25)
sq2ef_6 = QUAD(name="sq2ef_6", len=0.25)
sq3ef_6 = QUAD(name="sq3ef_6", len=0.25)
sq4ef_6 = QUAD(name="sq4ef_6", len=0.25)
sq5ef_6 = QUAD(name="sq5ef_6", len=0.25)
sq6ef_6 = QUAD(name="sq6ef_6", len=0.25)
sq7ef_6 = QUAD(name="sq7ef_6", len=0.25)
sq8ef_6 = QUAD(name="sq8ef_6", len=0.25)
sq9ef_6 = QUAD(name="sq9ef_6", len=0.25)
sq10ef_6 = QUAD(name="sq10ef_6", len=0.25)
sq11ef_6 = QUAD(name="sq11ef_6", len=0.25)
sq12ef_6 = QUAD(name="sq12ef_6", len=0.25)
sq13ef_6 = QUAD(name="sq13ef_6", len=0.25)
sq14ef_6 = QUAD(name="sq14ef_6", len=0.25)
sq3er_6 = QUAD(name="sq3er_6", len=0.25)
sq4er_6 = QUAD(name="sq4er_6", len=0.25)
sq5er_6 = QUAD(name="sq5er_6", len=0.25)
sq6er_6 = QUAD(name="sq6er_6", len=0.25)
sq7er_6 = QUAD(name="sq7er_6", len=0.25)
sq8er_6 = QUAD(name="sq8er_6", len=0.25)
sq9er_6 = QUAD(name="sq9er_6", len=0.25)
sq10er_6 = QUAD(name="sq10er_6", len=0.25)
#
# IP8 quadrupoles.
HQSS1_7 = QUAD(name="HQSS1_7", len=LQSS1/2.0, k1=KQSS1_7)
HQSS2_7 = QUAD(name="HQSS2_7", len=LQSS2/2.0, k1=KQSS2_7)
HQSS3_7 = QUAD(name="HQSS3_7", len=LQSS3/2.0, k1=KQSS3_7)
HQSS4_7 = QUAD(name="HQSS4_7", len=LQSS4/2.0, k1=KQSS4_7)
HQSS5_7 = QUAD(name="HQSS5_7", len=LQSS5/2.0, k1=KQSS5_7)
HQSS1_8 = QUAD(name="HQSS1_8", len=LQSS1/2.0, k1=KQSS1_8)
HQSS2_8 = QUAD(name="HQSS2_8", len=LQSS2/2.0, k1=KQSS2_8)
HQSS3_8 = QUAD(name="HQSS3_8", len=LQSS3/2.0, k1=KQSS3_8)
HQSS4_8 = QUAD(name="HQSS4_8", len=LQSS4/2.0, k1=KQSS4_8)
HQSS5_8 = QUAD(name="HQSS5_8", len=LQSS5/2.0, k1=KQSS5_8)
HQLS1_7 = QUAD(name="HQLS1_7", len=LQLS1/2.0, k1=KQLS1_7)
HQLS2_7 = QUAD(name="HQLS2_7", len=LQLS2/2.0, k1=KQLS2_7)
HQLS3_7 = QUAD(name="HQLS3_7", len=LQLS3/2.0, k1=KQLS3_7)
HQLS4_7 = QUAD(name="HQLS4_7", len=LQLS4/2.0, k1=KQLS4_7)
HQLS5_7 = QUAD(name="HQLS5_7", len=LQLS3/2.0, k1=KQLS5_7)
HQLS6_7 = QUAD(name="HQLS6_7", len=LQLS2/2.0, k1=KQLS6_7)
HQLS7_7 = QUAD(name="HQLS7_7", len=LQLS1/2.0, k1=KQLS7_7)
HQLS1_8 = QUAD(name="HQLS1_8", len=LQLS1/2.0, k1=KQLS1_8)
HQLS2_8 = QUAD(name="HQLS2_8", len=LQLS2/2.0, k1=KQLS2_8)
HQLS3_8 = QUAD(name="HQLS3_8", len=LQLS3/2.0, k1=KQLS3_8)
HQLS4_8 = QUAD(name="HQLS4_8", len=LQLS4/2.0, k1=KQLS4_8)
HQLS5_8 = QUAD(name="HQLS5_8", len=LQLS3/2.0, k1=KQLS5_8)
HQLS6_8 = QUAD(name="HQLS6_8", len=LQLS2/2.0, k1=KQLS6_8)
HQLS7_8 = QUAD(name="HQLS7_8", len=LQLS1/2.0, k1=KQLS7_8)
QFF1_7 = QUAD(name="QFF1_7", len=LQ50, k1=KFF1_7)
QFF2_7 = QUAD(name="QFF2_7", len=LQ50, k1=KFF2_7)
QFF3_7 = QUAD(name="QFF3_7", len=LQ50, k1=KFF3_7)
QFF4_7 = QUAD(name="QFF4_7", len=LQ50, k1=KFF4_7)
QFF5_7 = QUAD(name="QFF5_7", len=LQ50, k1=KFF5_7)
QFF6_7 = QUAD(name="QFF6_7", len=LQ50, k1=KFF6_7)
QFF1_8 = QUAD(name="QFF1_8", len=LQ50, k1=KFF1_8)
QFF2_8 = QUAD(name="QFF2_8", len=LQ50, k1=KFF2_8)
QFF3_8 = QUAD(name="QFF3_8", len=LQ50, k1=KFF3_8)
QFF4_8 = QUAD(name="QFF4_8", len=LQ50, k1=KFF4_8)
QFF5_8 = QUAD(name="QFF5_8", len=LQ50, k1=KFF5_8)
QFF6_8 = QUAD(name="QFF6_8", len=LQ50, k1=KFF6_8)
q0ef_8 = QUAD(name="q0ef_8", len=lq0ef_6, k1=K0EF_8)
q1ef_8 = QUAD(name="q1ef_8", len=lq1ef_6, k1=K1EF_8)
q2ef_8 = QUAD(name="q2ef_8", len=0.6, k1=K2EF_8)
q3ef_8 = QUAD(name="q3ef_8", len=0.6, k1=K3EF_8)
q4ef_8 = QUAD(name="q4ef_8", len=1.2, k1=K4EF_8)
q5ef_8 = QUAD(name="q5ef_8", len=1.2, k1=K5EF_8)
q6ef_8 = QUAD(name="q6ef_8", len=1.2, k1=K6EF_8)
q7ef_8 = QUAD(name="q7ef_8", len=1.2, k1=K7EF_8)
q8ef_8 = QUAD(name="q8ef_8", len=1.2, k1=K8EF_8)
q9ef_8 = QUAD(name="q9ef_8", len=1.2, k1=K9EF_8)
q10ef_8 = QUAD(name="q10ef_8", len=1.2, k1=K10EF_8)
q11ef_8 = QUAD(name="q11ef_8", len=1.2, k1=K11EF_8)
q12ef_8 = QUAD(name="q12ef_8", len=1.2, k1=K12EF_8)
q13ef_8 = QUAD(name="q13ef_8", len=1.2, k1=K13EF_8)
q14ef_8 = QUAD(name="q14ef_8", len=1.2, k1=K14EF_8)
q15ef_8 = QUAD(name="q15ef_8", len=1.2, k1=K15EF_8)
q1er_8 = QUAD(name="q1er_8", len=lq1er_6, k1=K1ER_8)
q2er_8 = QUAD(name="q2er_8", len=lq2er_6, k1=K2ER_8)
q3er_8 = QUAD(name="q3er_8", len=0.6, k1=K3ER_8)
q4er_8 = QUAD(name="q4er_8", len=0.6, k1=K4ER_8)
q5er_8 = QUAD(name="q5er_8", len=1.2, k1=K5ER_8)
q6er_8 = QUAD(name="q6er_8", len=1.2, k1=K6ER_8)
q7er_8 = QUAD(name="q7er_8", len=1.2, k1=K7ER_8)
q8er_8 = QUAD(name="q8er_8", len=1.2, k1=K8ER_8)
q9er_8 = QUAD(name="q9er_8", len=1.2, k1=K9ER_8)
q10er_8 = QUAD(name="q10er_8", len=1.2, k1=K10ER_8)
q11er_8 = QUAD(name="q11er_8", len=1.2, k1=K11ER_8)
q12er_8 = QUAD(name="q12er_8", len=1.2, k1=K12ER_8)
q13er_8 = QUAD(name="q13er_8", len=1.2, k1=K13ER_8)
q14er_8 = QUAD(name="q14er_8", len=1.2, k1=K14ER_8)
q15er_8 = QUAD(name="q15er_8", len=1.2, k1=K15ER_8)
#
# IP10 quadrupoles.
HQM22_9 = QUAD(name="HQM22_9", len=LQ80/2.0, k1=KM22_9)
HQM21_9 = QUAD(name="HQM21_9", len=LQ80/2.0, k1=KM21_9)
HQM20_9 = QUAD(name="HQM20_9", len=LQ80/2.0, k1=KM20_9)
HQM19_9 = QUAD(name="HQM19_9", len=LQ80/2.0, k1=KM19_9)
HQM18_9 = QUAD(name="HQM18_9", len=LQ80/2.0, k1=KM18_9)
HQM17_9 = QUAD(name="HQM17_9", len=LQ80/2.0, k1=KM17_9)
HQM16_9 = QUAD(name="HQM16_9", len=LQ80/2.0, k1=KM16_9)
HQM15_9 = QUAD(name="HQM15_9", len=LQ80/2.0, k1=KM15_9)
HQM14_9 = QUAD(name="HQM14_9", len=LQ80/2.0, k1=KM14_9)
HQM13_9 = QUAD(name="HQM13_9", len=LQ80/2.0, k1=KM13_9)
HQM12_9 = QUAD(name="HQM12_9", len=LQ80/2.0, k1=KM12_9)
HQDSS_10 = QUAD(name="HQDSS_10", len=LQ80/2.0, k1=KDSS_10)
HQFSS_10 = QUAD(name="HQFSS_10", len=LQ80/2.0, k1=KFSS_10)
HQDLSS_10 = QUAD(name="HQDLSS_10", len=LQ60, k1=KDSSL_10)
HQFLSS_10 = QUAD(name="HQFLSS_10", len=LQ60, k1=KFSSL_10)
HQM22_10 = QUAD(name="HQM22_10", len=LQ80/2.0, k1=KM22_10)
HQM21_10 = QUAD(name="HQM21_10", len=LQ80/2.0, k1=KM21_10)
HQM20_10 = QUAD(name="HQM20_10", len=LQ80/2.0, k1=KM20_10)
HQM19_10 = QUAD(name="HQM19_10", len=LQ80/2.0, k1=KM19_10)
HQM18_10 = QUAD(name="HQM18_10", len=LQ80/2.0, k1=KM18_10)
HQM17_10 = QUAD(name="HQM17_10", len=LQ80/2.0, k1=KM17_10)
HQM16_10 = QUAD(name="HQM16_10", len=LQ80/2.0, k1=KM16_10)
HQM15_10 = QUAD(name="HQM15_10", len=LQ80/2.0, k1=KM15_10)
HQM14_10 = QUAD(name="HQM14_10", len=LQ80/2.0, k1=KM14_10)
HQM13_10 = QUAD(name="HQM13_10", len=LQ80/2.0, k1=KM13_10)
HQM12_10 = QUAD(name="HQM12_10", len=LQ80/2.0, k1=KM12_10)
#
# IP12 quadrupoles.
HQM22_11 = QUAD(name="HQM22_11", len=LQ80/2.0, k1=KM22_11)
HQM21_11 = QUAD(name="HQM21_11", len=LQ80/2.0, k1=KM21_11)
HQM20_11 = QUAD(name="HQM20_11", len=LQ80/2.0, k1=KM20_11)
HQM19_11 = QUAD(name="HQM19_11", len=LQ80/2.0, k1=KM19_11)
HQM18_11 = QUAD(name="HQM18_11", len=LQ80/2.0, k1=KM18_11)
HQM17_11 = QUAD(name="HQM17_11", len=LQ80/2.0, k1=KM17_11)
HQM16_11 = QUAD(name="HQM16_11", len=LQ80/2.0, k1=KM16_11)
HQM15_11 = QUAD(name="HQM15_11", len=LQ80/2.0, k1=KM15_11)
HQM14_11 = QUAD(name="HQM14_11", len=LQ80/2.0, k1=KM14_11)
HQM13_11 = QUAD(name="HQM13_11", len=LQ80/2.0, k1=KM13_11)
HQM12_11 = QUAD(name="HQM12_11", len=LQ80/2.0, k1=KM12_11)
HQDSS_12 = QUAD(name="HQDSS_12", len=LQ80/2.0, k1=KDSS_12)
HQFSS_12 = QUAD(name="HQFSS_12", len=LQ80/2.0, k1=KFSS_12)
HQM22_12 = QUAD(name="HQM22_12", len=LQ80/2.0, k1=KM22_12)
HQM21_12 = QUAD(name="HQM21_12", len=LQ80/2.0, k1=KM21_12)
HQM20_12 = QUAD(name="HQM20_12", len=LQ80/2.0, k1=KM20_12)
HQM19_12 = QUAD(name="HQM19_12", len=LQ80/2.0, k1=KM19_12)
HQM18_12 = QUAD(name="HQM18_12", len=LQ80/2.0, k1=KM18_12)
HQM17_12 = QUAD(name="HQM17_12", len=LQ80/2.0, k1=KM17_12)
HQM16_12 = QUAD(name="HQM16_12", len=LQ80/2.0, k1=KM16_12)
HQM15_12 = QUAD(name="HQM15_12", len=LQ80/2.0, k1=KM15_12)
HQM14_12 = QUAD(name="HQM14_12", len=LQ80/2.0, k1=KM14_12)
#
# IP2 quadrupoles.
HQM22_1 = QUAD(name="HQM22_1", len=LQ80/2.0, k1=KM22_1)
HQM21_1 = QUAD(name="HQM21_1", len=LQ80/2.0, k1=KM21_1)
HQM20_1 = QUAD(name="HQM20_1", len=LQ80/2.0, k1=KM20_1)
HQM19_1 = QUAD(name="HQM19_1", len=LQ80/2.0, k1=KM19_1)
HQM18_1 = QUAD(name="HQM18_1", len=LQ80/2.0, k1=KM18_1)
HQM17_1 = QUAD(name="HQM17_1", len=LQ80/2.0, k1=KM17_1)
HQM16_1 = QUAD(name="HQM16_1", len=LQ80/2.0, k1=KM16_1)
HQM15_1 = QUAD(name="HQM15_1", len=LQ80/2.0, k1=KM15_1)
HQM14_1 = QUAD(name="HQM14_1", len=LQ80/2.0, k1=KM14_1)
HQM13_1 = QUAD(name="HQM13_1", len=LQ80/2.0, k1=KM13_1)
HQM12_1 = QUAD(name="HQM12_1", len=LQ80/2.0, k1=KM12_1)
HQDSS_2 = QUAD(name="HQDSS_2", len=LQ80/2.0, k1=KDSS_2)
HQFSS_2 = QUAD(name="HQFSS_2", len=LQ80/2.0, k1=KFSS_2)
HQM22_2 = QUAD(name="HQM22_2", len=LQ80/2.0, k1=KM22_2)
HQM21_2 = QUAD(name="HQM21_2", len=LQ80/2.0, k1=KM21_2)
HQM20_2 = QUAD(name="HQM20_2", len=LQ80/2.0, k1=KM20_2)
HQM19_2 = QUAD(name="HQM19_2", len=LQ80/2.0, k1=KM19_2)
HQM18_2 = QUAD(name="HQM18_2", len=LQ80/2.0, k1=KM18_2)
HQM17_2 = QUAD(name="HQM17_2", len=LQ80/2.0, k1=KM17_2)
HQM16_2 = QUAD(name="HQM16_2", len=LQ80/2.0, k1=KM16_2)
HQM15_2 = QUAD(name="HQM15_2", len=LQ80/2.0, k1=KM15_2)
HQM14_2 = QUAD(name="HQM14_2", len=LQ80/2.0, k1=KM14_2)
HQM13_2 = QUAD(name="HQM13_2", len=LQ80/2.0, k1=KM13_2)
HQM12_2 = QUAD(name="HQM12_2", len=LQ80/2.0, k1=KM12_2)
#
# IP4 quadrupoles.
HQD17_3 = QUAD(name="HQD17_3", len=LQ80/2.0, k1=KD17_3)
HQF16_3 = QUAD(name="HQF16_3", len=LQ80/2.0, k1=KF16_3)
HQD15_3 = QUAD(name="HQD15_3", len=LQ80/2.0, k1=KD15_3)
HQF14_3 = QUAD(name="HQF14_3", len=LQ80/2.0, k1=KF14_3)
HQD13_3 = QUAD(name="HQD13_3", len=LQ80/2.0, k1=KD13_3)
HQF12_3 = QUAD(name="HQF12_3", len=LQ80/2.0, k1=KF12_3)
HQD11_3 = QUAD(name="HQD11_3", len=LQ80/2.0, k1=KD11_3)
HQF10_3 = QUAD(name="HQF10_3", len=LQ80/2.0, k1=KF10_3)
HQD9_3 = QUAD(name="HQD9_3", len=LQ80/2.0, k1=KD9_3)
HQF8_3 = QUAD(name="HQF8_3", len=LQ80/2.0, k1=KF8_3)
HQD7_3 = QUAD(name="HQD7_3", len=LQ80/2.0, k1=KD7_3)
HQF6_3 = QUAD(name="HQF6_3", len=LQ80/2.0, k1=KF6_3)
HQD5_3 = QUAD(name="HQD5_3", len=LQ80/2.0, k1=KD5_3)
HQF4_3 = QUAD(name="HQF4_3", len=LQ80/2.0, k1=KF4_3)
HQD3_3 = QUAD(name="HQD3_3", len=LQ80/2.0, k1=KD3_3)
HQF2_3 = QUAD(name="HQF2_3", len=LQ80/2.0, k1=KF2_3)
HQD1_3 = QUAD(name="HQD1_3", len=LQ80/2.0, k1=KD1_3)
HQF18_4 = QUAD(name="HQF18_4", len=LQ80/2.0, k1=KF18_4)
HQD17_4 = QUAD(name="HQD17_4", len=LQ80/2.0, k1=KD17_4)
HQF16_4 = QUAD(name="HQF16_4", len=LQ80/2.0, k1=KF16_4)
HQD15_4 = QUAD(name="HQD15_4", len=LQ80/2.0, k1=KD15_4)
HQF14_4 = QUAD(name="HQF14_4", len=LQ80/2.0, k1=KF14_4)
HQD13_4 = QUAD(name="HQD13_4", len=LQ80/2.0, k1=KD13_4)
HQF12_4 = QUAD(name="HQF12_4", len=LQ80/2.0, k1=KF12_4)
HQD11_4 = QUAD(name="HQD11_4", len=LQ80/2.0, k1=KD11_4)
HQF10_4 = QUAD(name="HQF10_4", len=LQ80/2.0, k1=KF10_4)
HQD9_4 = QUAD(name="HQD9_4", len=LQ80/2.0, k1=KD9_4)
HQF8_4 = QUAD(name="HQF8_4", len=LQ80/2.0, k1=KF8_4)
HQD7_4 = QUAD(name="HQD7_4", len=LQ80/2.0, k1=KD7_4)
HQF6_4 = QUAD(name="HQF6_4", len=LQ80/2.0, k1=KF6_4)
HQD5_4 = QUAD(name="HQD5_4", len=LQ80/2.0, k1=KD5_4)
HQF4_4 = QUAD(name="HQF4_4", len=LQ80/2.0, k1=KF4_4)
HQD3_4 = QUAD(name="HQD3_4", len=LQ80/2.0, k1=KD3_4)
HQF2_4 = QUAD(name="HQF2_4", len=LQ80/2.0, k1=KF2_4)
HQD1_4 = QUAD(name="HQD1_4", len=LQ80/2.0, k1=KD1_4)
#
# ======= The sextupoles ==================================
# ARC 1 sextupoles.
SFM1_1 = KSEXT(name="SFM1_1", len=LSX, k2=KSFM1_1)
SF00_1 = KSEXT(name="SF00_1", len=LSX, k2=KSF00_1)
SD00_1 = KSEXT(name="SD00_1", len=LSX, k2=KSD00_1)
SF01_1 = KSEXT(name="SF01_1", len=LSX, k2=KSF01_1)
SD01_1 = KSEXT(name="SD01_1", len=LSX, k2=KSD01_1)
SF02_1 = KSEXT(name="SF02_1", len=LSX, k2=KSF02_1)
SD02_1 = KSEXT(name="SD02_1", len=LSX, k2=KSD02_1)
SF03_1 = KSEXT(name="SF03_1", len=LSX, k2=KSF03_1)
SD03_1 = KSEXT(name="SD03_1", len=LSX, k2=KSD03_1)
SF04_1 = KSEXT(name="SF04_1", len=LSX, k2=KSF04_1)
SD04_1 = KSEXT(name="SD04_1", len=LSX, k2=KSD04_1)
SF05_1 = KSEXT(name="SF05_1", len=LSX, k2=KSF05_1)
SD05_1 = KSEXT(name="SD05_1", len=LSX, k2=KSD05_1)
SF06_1 = KSEXT(name="SF06_1", len=LSX, k2=KSF06_1)
SD06_1 = KSEXT(name="SD06_1", len=LSX, k2=KSD06_1)
SF07_1 = KSEXT(name="SF07_1", len=LSX, k2=KSF07_1)
SD07_1 = KSEXT(name="SD07_1", len=LSX, k2=KSD07_1)
SF08_1 = KSEXT(name="SF08_1", len=LSX, k2=KSF08_1)
SD08_1 = KSEXT(name="SD08_1", len=LSX, k2=KSD08_1)
SF09_1 = KSEXT(name="SF09_1", len=LSX, k2=KSF09_1)
SD09_1 = KSEXT(name="SD09_1", len=LSX, k2=KSD09_1)
SF10_1 = KSEXT(name="SF10_1", len=LSX, k2=KSF10_1)
SD10_1 = KSEXT(name="SD10_1", len=LSX, k2=KSD10_1)
SF11_1 = KSEXT(name="SF11_1", len=LSX, k2=KSF11_1)
SD11_1 = KSEXT(name="SD11_1", len=LSX, k2=KSD11_1)
SF12_1 = KSEXT(name="SF12_1", len=LSX, k2=KSF12_1)
SD12_1 = KSEXT(name="SD12_1", len=LSX, k2=KSD12_1)
SF13_1 = KSEXT(name="SF13_1", len=LSX, k2=KSF13_1)
SD13_1 = KSEXT(name="SD13_1", len=LSX, k2=KSD13_1)
SF14_1 = KSEXT(name="SF14_1", len=LSX, k2=KSF14_1)
SD14_1 = KSEXT(name="SD14_1", len=LSX, k2=KSD14_1)
SF15_1 = KSEXT(name="SF15_1", len=LSX, k2=KSF15_1)
SD15_1 = KSEXT(name="SD15_1", len=LSX, k2=KSD15_1)
SF16_1 = KSEXT(name="SF16_1", len=LSX, k2=KSF16_1)
SD16_1 = KSEXT(name="SD16_1", len=LSX, k2=KSD16_1)
SF17_1 = KSEXT(name="SF17_1", len=LSX, k2=KSF17_1)
#
# ARC 3 sextupoles.
SF00_3 = KSEXT(name="SF00_3", len=LSX, k2=KSF00_3)
SD00_3 = KSEXT(name="SD00_3", len=LSX, k2=KSD00_3)
SF01_3 = KSEXT(name="SF01_3", len=LSX, k2=KSF01_3)
SD01_3 = KSEXT(name="SD01_3", len=LSX, k2=KSD01_3)
SF02_3 = KSEXT(name="SF02_3", len=LSX, k2=KSF02_3)
SD02_3 = KSEXT(name="SD02_3", len=LSX, k2=KSD02_3)
SF03_3 = KSEXT(name="SF03_3", len=LSX, k2=KSF03_3)
SD03_3 = KSEXT(name="SD03_3", len=LSX, k2=KSD03_3)
SF04_3 = KSEXT(name="SF04_3", len=LSX, k2=KSF04_3)
SD04_3 = KSEXT(name="SD04_3", len=LSX, k2=KSD04_3)
SF05_3 = KSEXT(name="SF05_3", len=LSX, k2=KSF05_3)
SD05_3 = KSEXT(name="SD05_3", len=LSX, k2=KSD05_3)
SF06_3 = KSEXT(name="SF06_3", len=LSX, k2=KSF06_3)
SD06_3 = KSEXT(name="SD06_3", len=LSX, k2=KSD06_3)
SF07_3 = KSEXT(name="SF07_3", len=LSX, k2=KSF07_3)
SD07_3 = KSEXT(name="SD07_3", len=LSX, k2=KSD07_3)
SF08_3 = KSEXT(name="SF08_3", len=LSX, k2=KSF08_3)
SD08_3 = KSEXT(name="SD08_3", len=LSX, k2=KSD08_3)
SF09_3 = KSEXT(name="SF09_3", len=LSX, k2=KSF09_3)
SD09_3 = KSEXT(name="SD09_3", len=LSX, k2=KSD09_3)
SF10_3 = KSEXT(name="SF10_3", len=LSX, k2=KSF10_3)
SD10_3 = KSEXT(name="SD10_3", len=LSX, k2=KSD10_3)
SF11_3 = KSEXT(name="SF11_3", len=LSX, k2=KSF11_3)
SD11_3 = KSEXT(name="SD11_3", len=LSX, k2=KSD11_3)
SF12_3 = KSEXT(name="SF12_3", len=LSX, k2=KSF12_3)
SD12_3 = KSEXT(name="SD12_3", len=LSX, k2=KSD12_3)
SF13_3 = KSEXT(name="SF13_3", len=LSX, k2=KSF13_3)
SD13_3 = KSEXT(name="SD13_3", len=LSX, k2=KSD13_3)
SF14_3 = KSEXT(name="SF14_3", len=LSX, k2=KSF14_3)
SD14_3 = KSEXT(name="SD14_3", len=LSX, k2=KSD14_3)
SF15_3 = KSEXT(name="SF15_3", len=LSX, k2=KSF15_3)
SD15_3 = KSEXT(name="SD15_3", len=LSX, k2=KSD15_3)
SF16_3 = KSEXT(name="SF16_3", len=LSX, k2=KSF16_3)
SD16_3 = KSEXT(name="SD16_3", len=LSX, k2=KSD16_3)
SF17_3 = KSEXT(name="SF17_3", len=LSX, k2=KSF17_3)
SF18_3 = KSEXT(name="SF18_3", len=LSX, k2=KSF18_3)
#
# ARC 5 sextupoles.
SFM1_5 = KSEXT(name="SFM1_5", len=LSXL, k2=KSFM1_5)
SF00_5 = KSEXT(name="SF00_5", len=LSXL, k2=KSF00_5)
SD00_5 = KSEXT(name="SD00_5", len=LSXL, k2=KSD00_5)
SF01_5 = KSEXT(name="SF01_5", len=LSX, k2=KSF01_5)
SD01_5 = KSEXT(name="SD01_5", len=LSXL, k2=KSD01_5)
SF02_5 = KSEXT(name="SF02_5", len=LSX, k2=KSF02_5)
SD02_5 = KSEXT(name="SD02_5", len=LSXL, k2=KSD02_5)
SF03_5 = KSEXT(name="SF03_5", len=LSX, k2=KSF03_5)
SD03_5 = KSEXT(name="SD03_5", len=LSXL, k2=KSD03_5)
SF04_5 = KSEXT(name="SF04_5", len=LSX, k2=KSF04_5)
SD04_5 = KSEXT(name="SD04_5", len=LSXL, k2=KSD04_5)
SF05_5 = KSEXT(name="SF05_5", len=LSX, k2=KSF05_5)
SD05_5 = KSEXT(name="SD05_5", len=LSXL, k2=KSD05_5)
SF06_5 = KSEXT(name="SF06_5", len=LSX, k2=KSF06_5)
SD06_5 = KSEXT(name="SD06_5", len=LSXL, k2=KSD06_5)
SF07_5 = KSEXT(name="SF07_5", len=LSX, k2=KSF07_5)
SD07_5 = KSEXT(name="SD07_5", len=LSXL, k2=KSD07_5)
SF08_5 = KSEXT(name="SF08_5", len=LSX, k2=KSF08_5)
SD08_5 = KSEXT(name="SD08_5", len=LSXL, k2=KSD08_5)
SF09_5 = KSEXT(name="SF09_5", len=LSX, k2=KSF09_5)
SD09_5 = KSEXT(name="SD09_5", len=LSXL, k2=KSD09_5)
SF10_5 = KSEXT(name="SF10_5", len=LSX, k2=KSF10_5)
SD10_5 = KSEXT(name="SD10_5", len=LSXL, k2=KSD10_5)
SF11_5 = KSEXT(name="SF11_5", len=LSX, k2=KSF11_5)
SD11_5 = KSEXT(name="SD11_5", len=LSXL, k2=KSD11_5)
SF12_5 = KSEXT(name="SF12_5", len=LSX, k2=KSF12_5)
SD12_5 = KSEXT(name="SD12_5", len=LSXL, k2=KSD12_5)
SF13_5 = KSEXT(name="SF13_5", len=LSX, k2=KSF13_5)
SD13_5 = KSEXT(name="SD13_5", len=LSXL, k2=KSD13_5)
SF14_5 = KSEXT(name="SF14_5", len=LSX, k2=KSF14_5)
SD14_5 = KSEXT(name="SD14_5", len=LSXL, k2=KSD14_5)
SF15_5 = KSEXT(name="SF15_5", len=LSX, k2=KSF15_5)
SD15_5 = KSEXT(name="SD15_5", len=LSXL, k2=KSD15_5)
SF16_5 = KSEXT(name="SF16_5", len=LSX, k2=KSF16_5)
SD16_5 = KSEXT(name="SD16_5", len=LSXL, k2=KSD16_5)
#
# ARC 7 sextupoles.
SF01_7 = KSEXT(name="SF01_7", len=LSX, k2=KSF01_7)
SD01_7 = KSEXT(name="SD01_7", len=LSXL, k2=KSD01_7)
SF02_7 = KSEXT(name="SF02_7", len=LSX, k2=KSF02_7)
SD02_7 = KSEXT(name="SD02_7", len=LSXL, k2=KSD02_7)
SF03_7 = KSEXT(name="SF03_7", len=LSX, k2=KSF03_7)
SD03_7 = KSEXT(name="SD03_7", len=LSXL, k2=KSD03_7)
SF04_7 = KSEXT(name="SF04_7", len=LSX, k2=KSF04_7)
SD04_7 = KSEXT(name="SD04_7", len=LSXL, k2=KSD04_7)
SF05_7 = KSEXT(name="SF05_7", len=LSX, k2=KSF05_7)
SD05_7 = KSEXT(name="SD05_7", len=LSXL, k2=KSD05_7)
SF06_7 = KSEXT(name="SF06_7", len=LSX, k2=KSF06_7)
SD06_7 = KSEXT(name="SD06_7", len=LSXL, k2=KSD06_7)
SF07_7 = KSEXT(name="SF07_7", len=LSX, k2=KSF07_7)
SD07_7 = KSEXT(name="SD07_7", len=LSXL, k2=KSD07_7)
SF08_7 = KSEXT(name="SF08_7", len=LSX, k2=KSF08_7)
SD08_7 = KSEXT(name="SD08_7", len=LSXL, k2=KSD08_7)
SF09_7 = KSEXT(name="SF09_7", len=LSX, k2=KSF09_7)
SD09_7 = KSEXT(name="SD09_7", len=LSXL, k2=KSD09_7)
SF10_7 = KSEXT(name="SF10_7", len=LSX, k2=KSF10_7)
SD10_7 = KSEXT(name="SD10_7", len=LSXL, k2=KSD10_7)
SF11_7 = KSEXT(name="SF11_7", len=LSX, k2=KSF11_7)
SD11_7 = KSEXT(name="SD11_7", len=LSXL, k2=KSD11_7)
SF12_7 = KSEXT(name="SF12_7", len=LSX, k2=KSF12_7)
SD12_7 = KSEXT(name="SD12_7", len=LSXL, k2=KSD12_7)
SF13_7 = KSEXT(name="SF13_7", len=LSX, k2=KSF13_7)
SD13_7 = KSEXT(name="SD13_7", len=LSXL, k2=KSD13_7)
SF14_7 = KSEXT(name="SF14_7", len=LSX, k2=KSF14_7)
SD14_7 = KSEXT(name="SD14_7", len=LSXL, k2=KSD14_7)
SF15_7 = KSEXT(name="SF15_7", len=LSX, k2=KSF15_7)
SD15_7 = KSEXT(name="SD15_7", len=LSXL, k2=KSD15_7)
SF16_7 = KSEXT(name="SF16_7", len=LSX, k2=KSF16_7)
SD16_7 = KSEXT(name="SD16_7", len=LSXL, k2=KSD16_7)
#
# ARC 9 sextupoles.
SF01_9 = KSEXT(name="SF01_9", len=LSX, k2=KSF01_9)
SD01_9 = KSEXT(name="SD01_9", len=LSXL, k2=KSD01_9)
SF02_9 = KSEXT(name="SF02_9", len=LSX, k2=KSF02_9)
SD02_9 = KSEXT(name="SD02_9", len=LSXL, k2=KSD02_9)
SF03_9 = KSEXT(name="SF03_9", len=LSX, k2=KSF03_9)
SD03_9 = KSEXT(name="SD03_9", len=LSXL, k2=KSD03_9)
SF04_9 = KSEXT(name="SF04_9", len=LSX, k2=KSF04_9)
SD04_9 = KSEXT(name="SD04_9", len=LSXL, k2=KSD04_9)
SF05_9 = KSEXT(name="SF05_9", len=LSX, k2=KSF05_9)
SD05_9 = KSEXT(name="SD05_9", len=LSXL, k2=KSD05_9)
SF06_9 = KSEXT(name="SF06_9", len=LSX, k2=KSF06_9)
SD06_9 = KSEXT(name="SD06_9", len=LSXL, k2=KSD06_9)
SF07_9 = KSEXT(name="SF07_9", len=LSX, k2=KSF07_9)
SD07_9 = KSEXT(name="SD07_9", len=LSXL, k2=KSD07_9)
SF08_9 = KSEXT(name="SF08_9", len=LSX, k2=KSF08_9)
SD08_9 = KSEXT(name="SD08_9", len=LSXL, k2=KSD08_9)
SF09_9 = KSEXT(name="SF09_9", len=LSX, k2=KSF09_9)
SD09_9 = KSEXT(name="SD09_9", len=LSXL, k2=KSD09_9)
SF10_9 = KSEXT(name="SF10_9", len=LSX, k2=KSF10_9)
SD10_9 = KSEXT(name="SD10_9", len=LSXL, k2=KSD10_9)
SF11_9 = KSEXT(name="SF11_9", len=LSX, k2=KSF11_9)
SD11_9 = KSEXT(name="SD11_9", len=LSXL, k2=KSD11_9)
SF12_9 = KSEXT(name="SF12_9", len=LSX, k2=KSF12_9)
SD12_9 = KSEXT(name="SD12_9", len=LSXL, k2=KSD12_9)
SF13_9 = KSEXT(name="SF13_9", len=LSX, k2=KSF13_9)
SD13_9 = KSEXT(name="SD13_9", len=LSXL, k2=KSD13_9)
SF14_9 = KSEXT(name="SF14_9", len=LSX, k2=KSF14_9)
SD14_9 = KSEXT(name="SD14_9", len=LSXL, k2=KSD14_9)
SF15_9 = KSEXT(name="SF15_9", len=LSX, k2=KSF15_9)
SD15_9 = KSEXT(name="SD15_9", len=LSXL, k2=KSD15_9)
SF16_9 = KSEXT(name="SF16_9", len=LSX, k2=KSF16_9)
SD16_9 = KSEXT(name="SD16_9", len=LSXL, k2=KSD16_9)
SF17_9 = KSEXT(name="SF17_9", len=LSX, k2=KSF17_9)
#
# ARC 11 sextupoles.
SF00_11 = KSEXT(name="SF00_11", len=LSX, k2=KSF00_11)
SD00_11 = KSEXT(name="SD00_11", len=LSX, k2=KSD00_11)
SF01_11 = KSEXT(name="SF01_11", len=LSX, k2=KSF01_11)
SD01_11 = KSEXT(name="SD01_11", len=LSX, k2=KSD01_11)
SF02_11 = KSEXT(name="SF02_11", len=LSX, k2=KSF02_11)
SD02_11 = KSEXT(name="SD02_11", len=LSX, k2=KSD02_11)
SF03_11 = KSEXT(name="SF03_11", len=LSX, k2=KSF03_11)
SD03_11 = KSEXT(name="SD03_11", len=LSX, k2=KSD03_11)
SF04_11 = KSEXT(name="SF04_11", len=LSX, k2=KSF04_11)
SD04_11 = KSEXT(name="SD04_11", len=LSX, k2=KSD04_11)
SF05_11 = KSEXT(name="SF05_11", len=LSX, k2=KSF05_11)
SD05_11 = KSEXT(name="SD05_11", len=LSX, k2=KSD05_11)
SF06_11 = KSEXT(name="SF06_11", len=LSX, k2=KSF06_11)
SD06_11 = KSEXT(name="SD06_11", len=LSX, k2=KSD06_11)
SF07_11 = KSEXT(name="SF07_11", len=LSX, k2=KSF07_11)
SD07_11 = KSEXT(name="SD07_11", len=LSX, k2=KSD07_11)
SF08_11 = KSEXT(name="SF08_11", len=LSX, k2=KSF08_11)
SD08_11 = KSEXT(name="SD08_11", len=LSX, k2=KSD08_11)
SF09_11 = KSEXT(name="SF09_11", len=LSX, k2=KSF09_11)
SD09_11 = KSEXT(name="SD09_11", len=LSX, k2=KSD09_11)
SF10_11 = KSEXT(name="SF10_11", len=LSX, k2=KSF10_11)
SD10_11 = KSEXT(name="SD10_11", len=LSX, k2=KSD10_11)
SF11_11 = KSEXT(name="SF11_11", len=LSX, k2=KSF11_11)
SD11_11 = KSEXT(name="SD11_11", len=LSX, k2=KSD11_11)
SF12_11 = KSEXT(name="SF12_11", len=LSX, k2=KSF12_11)
SD12_11 = KSEXT(name="SD12_11", len=LSX, k2=KSD12_11)
SF13_11 = KSEXT(name="SF13_11", len=LSX, k2=KSF13_11)
SD13_11 = KSEXT(name="SD13_11", len=LSX, k2=KSD13_11)
SF14_11 = KSEXT(name="SF14_11", len=LSX, k2=KSF14_11)
SD14_11 = KSEXT(name="SD14_11", len=LSX, k2=KSD14_11)
SF15_11 = KSEXT(name="SF15_11", len=LSX, k2=KSF15_11)
SD15_11 = KSEXT(name="SD15_11", len=LSX, k2=KSD15_11)
SF16_11 = KSEXT(name="SF16_11", len=LSX, k2=KSF16_11)
SD16_11 = KSEXT(name="SD16_11", len=LSX, k2=KSD16_11)
SF17_11 = KSEXT(name="SF17_11", len=LSX, k2=KSF17_11)
SF18_11 = KSEXT(name="SF18_11", len=LSX, k2=KSF18_11)
#
# Straight section 2
SX41_2 = KSEXT(name="SX41_2", len=LSX, k2=S41_2)
SX42_2 = KSEXT(name="SX42_2", len=LSX, k2=S42_2)
SX43_2 = KSEXT(name="SX43_2", len=LSX, k2=S43_2)
SX44_2 = KSEXT(name="SX44_2", len=LSX, k2=S44_2)
SX45_2 = KSEXT(name="SX45_2", len=LSX, k2=S45_2)
SX46_2 = KSEXT(name="SX46_2", len=LSX, k2=S46_2)
SX47_2 = KSEXT(name="SX47_2", len=LSX, k2=S47_2)
SX48_2 = KSEXT(name="SX48_2", len=LSX, k2=S48_2)
SX49_2 = KSEXT(name="SX49_2", len=LSX, k2=S49_2)
SX50_2 = KSEXT(name="SX50_2", len=LSX, k2=S50_2)
SX51_2 = KSEXT(name="SX51_2", len=LSX, k2=S51_2)
SX52_2 = KSEXT(name="SX52_2", len=LSX, k2=S52_2)
#
# Straight section 4
SX41_4 = KSEXT(name="SX41_4", len=LSX, k2=S41_4)
SX42_4 = KSEXT(name="SX42_4", len=LSX, k2=S42_4)
SX43_4 = KSEXT(name="SX43_4", len=LSX, k2=S43_4)
SX44_4 = KSEXT(name="SX44_4", len=LSX, k2=S44_4)
SX45_4 = KSEXT(name="SX45_4", len=LSX, k2=S45_4)
SX46_4 = KSEXT(name="SX46_4", len=LSX, k2=S46_4)
SX47_4 = KSEXT(name="SX47_4", len=LSX, k2=S47_4)
SX48_4 = KSEXT(name="SX48_4", len=LSX, k2=S48_4)
SX49_4 = KSEXT(name="SX49_4", len=LSX, k2=S49_4)
SX50_4 = KSEXT(name="SX50_4", len=LSX, k2=S50_4)
SX51_4 = KSEXT(name="SX51_4", len=LSX, k2=S51_4)
SX52_4 = KSEXT(name="SX52_4", len=LSX, k2=S52_4)
#
# ======= Correctors. ======================================
...
#
# ======= RF Cavities. ====================================
RF0 = RFCA(name="RF0", len=LRF, volt=VOLT_RF, h=HRMN_RF, lag=LAG_RF, freq=591.1397738e6, energy=E)  
RF_CRAB = CRABCAVITY_K2(name="RF_CRAB", len=lecrab, volt=0.0, freq=394.0e6, k2=100.0)
#
# ======= Drifts. =========================================
...
OD12U = DRIFT(name="OD12U", len=7.0)
...
twi = twissring(RING, 0.0, 0)
println("phase advance of the #2 and #3 crab cavities: ", (twi[952].dmux - twi[916].dmux)/pi, " pi and ", (twi[952].dmuy - twi[916].dmuy)/pi, " pi")

# turn on 2 crab cavities
volt_crab = 2.9e4
RING[952].volt = volt_crab
RING[916].volt = -volt_crab
RING[952].k2 = 1.0
RING[916].k2 = 1.0

# turn on RF cavities
volt_RF = 3.78e6
RFid = findelem(RING, RFCA)
for id in RFid
    RING[id].volt = volt_RF
    RING[id].philag = 0.0
end
...
using PyCall
np = pyimport("numpy")
x_min, x_max = -0.001+1e-5, 0.001+1e-5
y_min, y_max = 0.0001, 0.0001
z_min, z_max = -0.005+1e-5, 0.005+1e-5
n_x, n_y, n_z = 50, 1, 50
